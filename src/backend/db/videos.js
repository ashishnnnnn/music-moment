...
export const videos = [
  ...
  },
  {
    _id: "YLoYt8H7kjM",
    title:
      "Arijit Singh with his soulful performance | 6th Royal Stag Mirchi Music Awards | Radio Mirchi",
    singer: "Arijit Singh",
    views: 152,
  ...
  },
  {
    _id: "d5pEQX3yWy8",
    title:
      "Arijit Singh | Live | Dil Sambhal Ja Zara | Man Bawre | Full Video | 2021 | HD",
    singer: "Arijit Singh",
    views: 6,
    channel_name: "FilmyMirchi",
    img_src:
  ...
  {
    _id: "dTu5dTEzVM4",
    title: "Tune Jo Na Kaha || Mohit Chauhan",
  ...
  },
  {
    _id: "yHWPO9DDnsk",
    title:
      "Bheegi Si Bhaagi Si Full Video - Raajneeti|Ranbir,Katrina|Mohit Chauhan, Antara M|Pritm",
    singer: "Mohit Chauhan",
    views: 65,
    channel_name: "SonyMusicIndiaVEVO",
    img_src:
  ...
  },
  {
    _id: "Gg6NMU4ivXM",
    title:
      "Kya Mujhe Pyar Lyrical Video Song | Woh Lamhe | Pritam | K.K. | Shiny Ahuja, Kangna Ranaut",
    singer: "KK",
    views: 40,
    ...
    channel_src:
      "https://yt3.ggpht.com/ytc/AKedOLT-zOv1lmBQyqijFe1Z1y1p0a3nRbnR9tRZfsbBtA=s176-c-k-c0x00ffffff-no-rj-mo",
  ...
  {
    _id: "Rq7tyOcVgLQ",
    title: "Kyon - Barfi|Pritam|Papon|Sunidhi|Ranbir|Priyanka",
    singer: "Papon",
    views: 102,
    channel_name: "SonyMusicIndiaVEVO",
    img_src:
  ...
  },
  {
    _id: "a9Hxkc9YxGE",
    title:
      "Bulleya | Full Song | Sultan | Salman Khan, Anushka Sharma | Papon | Vishal & Shekhar | Irshad Kamil",
    singer: "PAPON",
    views: 60,
    channel_name: "YRF",
    img_src:
